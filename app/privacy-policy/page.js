      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="text-gray-700 space-y-6">
          ...
          <section>
            ...
            <p>
              iPrintRush ("we", "us", "our") operates the website. This page informs you of our policies
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Personal Data:</strong> Name, email address, phone number, postal address, and
                payment information
              </li>
              <li>
          ...
          <section>
            ...
            <p>iPrintRush uses the collected data for various purposes:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
